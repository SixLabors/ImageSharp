    ...
    private readonly struct CdfApplicationRowOperation : IRowOperation<Vector4>
    {
        ...
        public void Invoke(int y, Span<Vector4> span)
        {
            ...
            for (int x = 0; x < this.bounds.Width; x++)
            {
                ...
                float luminanceEqualized = Extensions.UnsafeAdd(ref cdfBase, (uint)luminance) / noOfPixelsMinusCdfMin;
                Extensions.UnsafeAdd(ref vectorRef, (uint)x) = new Vector4(luminanceEqualized, luminanceEqualized, luminanceEqualized, vector.W);
            }
