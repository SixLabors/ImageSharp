...
- [~] Implement real rate-distortion selection and make quality and effort change work, size, and output quality. The complete luma and joint spatial-chroma candidate sets now perform live rate-distortion selection; quality mapping, effort-dependent pruning, and the remaining searches are not implemented.
