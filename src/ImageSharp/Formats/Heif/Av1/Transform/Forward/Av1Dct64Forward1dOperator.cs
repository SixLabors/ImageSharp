...
/// <summary>
/// Defines the 64-point AV1 forward discrete cosine transform operator.
/// </summary>
internal readonly partial struct Av1Dct64Forward1dOperator : IAv1Transform1dOperator
{
    /// <summary>
    /// Applies the normative 64-point AV1 forward discrete cosine transform.
    /// </summary>
    /// <param name="input">The 64 spatial-domain residual values.</param>
    /// <param name="output">The 64 frequency-domain coefficients.</param>
