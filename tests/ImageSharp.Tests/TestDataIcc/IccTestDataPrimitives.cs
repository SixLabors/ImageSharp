...
internal static class IccTestDataPrimitives
{
    ...
    [
        [Fix16_Min, Fix16_ValMin],
        [Fix16_0, 0],
        [Fix16_4, 4],
        [Fix16_Max, Fix16_ValMax]
    ];
    ...
    [
        [Ascii_Rand, Ascii_Rand_Length, Ascii_ValRand],
        [Ascii_Rand, 4, Ascii_ValRandLength4],
        [Ascii_NullRand, Ascii_NullRand_LengthNoNull, Ascii_ValRandLength4]
    ];

    public static readonly object[][] AsciiWriteTestData =
    [
        [Ascii_Rand, Ascii_ValRand],
        [Ascii_NullRand, Ascii_ValNullRand]
    ];

    public static readonly object[][] AsciiPaddingTestData =
    [
        [Ascii_PaddedRand, Ascii_PaddedRand_Length, Ascii_ValRand, true],
        [Ascii_RandLength4, 4, Ascii_ValRand, false]
    ];
