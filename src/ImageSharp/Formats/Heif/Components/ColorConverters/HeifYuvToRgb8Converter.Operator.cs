...
internal static partial class HeifYuvToRgb8Converter
{
    ...
    /// </summary>
    private interface IHeifYuvToRgb8Operator
    {
        /// <summary>
        /// Converts sixteen YCbCr samples to eight-bit RGB lanes.
        /// </summary>
        ...
        /// <summary>
        /// Converts eight YCbCr samples to eight-bit RGB lanes.
        /// </summary>
        /// <param name="y">The luma lanes.</param>
        /// <param name="cb">The blue-difference lanes.</param>
        /// <param name="cr">The red-difference lanes.</param>
        ...
        /// <summary>
        /// Converts four YCbCr samples to eight-bit RGB lanes.
        /// </summary>
        /// <param name="y">The luma lanes.</param>
        /// <param name="cb">The blue-difference lanes.</param>
        /// <param name="cr">The red-difference lanes.</param>
    ...
    private static void ConvertRow<TOperator>(
        ...
        int subsamplingX,
        in ConversionParameters parameters)
        where TOperator : struct, IHeifYuvToRgb8Operator
    {
