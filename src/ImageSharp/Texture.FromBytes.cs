...
namespace SixLabors.ImageSharp
{
    ...
    public partial class Texture
    {
        ...
        public static Texture Load(byte[] data, out IImageFormat format) =>
        ...
        /// <returns>The <see cref="Texture"/>.</returns>
        public static Texture Load(byte[] data, IImageDecoder decoder) => Load(Configuration.Default, data, decoder);
        ...
        /// <param name="decoder">The decoder.</param>
        /// <returns>The <see cref="Texture"/>.</returns>
        public static Texture Load(Configuration config, byte[] data, IImageDecoder decoder)
        {
            using (var stream = new MemoryStream(data))
            {
        ...
        /// <returns>The <see cref="Texture"/>.</returns>
        public static Texture Load(Configuration config, byte[] data, out IImageFormat format)
        {
            using (var stream = new MemoryStream(data))
            {
        ...
        /// <param name="decoder">The decoder.</param>
        /// <returns>The <see cref="Texture"/>.</returns>
        public static Texture Load(ReadOnlySpan<byte> data, IImageDecoder decoder) =>
        ...
        /// <param name="format">The detected format.</param>
        /// <returns>The <see cref="Texture"/>.</returns>
        public static Texture Load(ReadOnlySpan<byte> data, out IImageFormat format) =>
            Load(Configuration.Default, data, out format);
