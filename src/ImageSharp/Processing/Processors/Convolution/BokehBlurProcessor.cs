...
public sealed class BokehBlurProcessor : IImageProcessor
{
    ...
    internal readonly struct SecondPassConvolutionRowOperation : IRowOperation
    {
        ...
        public void Invoke(int y)
        {
            ...
            ref Complex64 kernelStart = ref Extensions.GetUnsafeArrayDataReference(this.kernel);
            ref Complex64 kernelEnd = ref Extensions.UnsafeAdd(ref kernelStart, (uint)kernelSize);
            ...
            while (Unsafe.IsAddressLessThan(ref kernelStart, ref kernelEnd))
            {
                ...
                ref ComplexVector4 sourceEnd = ref Extensions.UnsafeAdd(ref sourceBase, (uint)boundsWidth);
