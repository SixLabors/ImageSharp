...
/// <summary>
/// Defines the 32-point AV1 forward discrete cosine transform operator.
/// </summary>
internal readonly partial struct Av1Dct32Forward1dOperator : IAv1Transform1dOperator
{
    /// <summary>
    /// Applies the normative 32-point AV1 forward discrete cosine transform.
    /// </summary>
    /// <param name="input">The 32 spatial-domain residual values.</param>
    /// <param name="output">The 32 frequency-domain coefficients.</param>
