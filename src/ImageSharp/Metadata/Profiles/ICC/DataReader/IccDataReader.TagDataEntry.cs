...
internal sealed partial class IccDataReader
{
    ...
    {
        return new(this.ReadParametricCurve());
    }
    ...
    {
        return new(this.ReadAsciiString(4));
    }
    ...
    {
        return new(this.ReadAsciiString((int)size - 8)); // 8 is the tag header size
    }
