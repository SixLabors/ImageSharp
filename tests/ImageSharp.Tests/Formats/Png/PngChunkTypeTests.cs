...
namespace SixLabors.ImageSharp.Tests.Formats.Png
{
    public class PngChunkTypeTests
    {
        ...
        public void ChunkTypeIdsAreCorrect()
        {
            ...
            Assert.Equal(PngChunkType.AnimationControl, GetType("acTL"));
            Assert.Equal(PngChunkType.FrameControl,     GetType("fcTL"));
            Assert.Equal(PngChunkType.FrameData,        GetType("fdAT"));
        }
