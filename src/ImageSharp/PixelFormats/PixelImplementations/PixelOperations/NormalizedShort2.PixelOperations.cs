...
public partial struct NormalizedShort2
{
    ...
    internal class PixelOperations : PixelOperations<NormalizedShort2>
    {
        ...
        /// <inheritdoc />
        protected override void ToAssociatedVector4(Configuration configuration, ReadOnlySpan<NormalizedShort2> source, Span<Vector4> destination) => this.ToUnassociatedVector4(configuration, source, destination);

        /// <inheritdoc />
        protected override void ToAssociatedScaledVector4(Configuration configuration, ReadOnlySpan<NormalizedShort2> source, Span<Vector4> destination) => this.ToUnassociatedScaledVector4(configuration, source, destination);

        /// <inheritdoc />
        protected override void FromAssociatedVector4Destructive(Configuration configuration, Span<Vector4> source, Span<NormalizedShort2> destination)
        {
