...
public partial struct Rgb96 : IPixel<Rgb96>, IEquatable<Rgb96>
{
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PixelOperations<Rgb96> CreatePixelOperations() => new PixelOperations();
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Rgb96 FromUnassociatedScaledVector4(Vector4 source) => FromScaledVector4(source);

    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Rgb96 FromAssociatedScaledVector4(Vector4 source)
    {
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Rgb96 FromUnassociatedVector4(Vector4 source) => FromVector4(source);

    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Rgb96 FromAssociatedVector4(Vector4 source)
    {
        // The destination has implicit alpha one, but associated input must be restored before its alpha is discarded.
        Numerics.UnPremultiply(ref source);
