...
namespace SixLabors.ImageSharp
{
    ...
    public abstract partial class Texture
    {
        ...
        public static Texture Load(string path, out IImageFormat format) => Load(Configuration.Default, path, out format);
        ...
        /// </exception>
        /// <returns>The <see cref="Texture"/>.</returns>
        public static Texture Load(Configuration config, string path, IImageDecoder decoder)
        {
        ...
        /// </exception>
        /// <returns>The <see cref="Texture"/>.</returns>
        public static Texture Load(string path, IImageDecoder decoder) => Load(Configuration.Default, path, decoder);

        /// <summary>
        /// Create a new instance of the <see cref="Texture{TPixel}"/> class from the given file.
        /// </summary>
        /// <param name="path">The file path to the image.</param>
        /// <exception cref="NotSupportedException">
        /// Thrown if the stream is not readable nor seekable.
        ...
        public static Texture<TPixel> Load<TPixel>(string path)
        ...
        /// <typeparam name="TPixel">The pixel format.</typeparam>
        /// <returns>A new <see cref="Texture{TPixel}"/>.</returns>
        public static Texture<TPixel> Load<TPixel>(string path, out IImageFormat format)
            where TPixel : struct, IPixel<TPixel>
        {
        ...
        /// <typeparam name="TPixel">The pixel format.</typeparam>
        /// <returns>A new <see cref="Texture{TPixel}"/>.</returns>
        public static Texture<TPixel> Load<TPixel>(Configuration config, string path)
            where TPixel : struct, IPixel<TPixel>
        {
            using (Stream stream = config.FileSystem.OpenRead(path))
            {
        ...
        /// <typeparam name="TPixel">The pixel format.</typeparam>
        /// <returns>A new <see cref="Texture{TPixel}"/>.</returns>
        public static Texture<TPixel> Load<TPixel>(Configuration config, string path, out IImageFormat format)
            where TPixel : struct, IPixel<TPixel>
        {
            using (Stream stream = config.FileSystem.OpenRead(path))
            {
        ...
        /// </exception>
        /// <returns>A new <see cref="Texture{TPixel}"/>.</returns>
        public static Texture Load(Configuration config, string path, out IImageFormat format)
        {
            using (Stream stream = config.FileSystem.OpenRead(path))
            {
        ...
        /// <typeparam name="TPixel">The pixel format.</typeparam>
        /// <returns>A new <see cref="Texture{TPixel}"/>.</returns>
        public static Texture<TPixel> Load<TPixel>(string path, IImageDecoder decoder)
            where TPixel : struct, IPixel<TPixel>
        {
        ...
        /// <typeparam name="TPixel">The pixel format.</typeparam>
        /// <returns>A new <see cref="Texture{TPixel}"/>.</returns>
        public static Texture<TPixel> Load<TPixel>(Configuration config, string path, IImageDecoder decoder)
            where TPixel : struct, IPixel<TPixel>
        {
            using (Stream stream = config.FileSystem.OpenRead(path))
            {
