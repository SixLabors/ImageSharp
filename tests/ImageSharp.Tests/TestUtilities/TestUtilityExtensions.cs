...
namespace ImageSharp.Tests.TestUtilities
{
    ...
    public static class TestUtilityExtensions
    {
        ...
        public static bool IsEquivalentTo<TColor, TPacked>(
            this Image<TColor, TPacked> a,
            Image<TColor, TPacked> b,
            bool compareAlpha = true) where TColor : struct, IPackedPixel<TPacked>
