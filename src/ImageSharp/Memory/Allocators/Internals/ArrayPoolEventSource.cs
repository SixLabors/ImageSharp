...
{
    [EventSource(Name = "SixLabors.ImageSharp.Memory.Allocators.Internals.ArrayPoolEventSource")]
    internal sealed class ArrayPoolEventSource : EventSource
    {
        ...
        internal unsafe void BufferRented(int bufferId, int bufferSize, int poolId, int bucketId)
        {
            ...
            this.WriteEventCore(1, 4, payload);
        }
        ...
        internal unsafe void BufferAllocated(int bufferId, int bufferSize, int poolId, int bucketId, BufferAllocatedReason reason)
        {
            ...
            this.WriteEventCore(2, 5, payload);
        }
        ...
        internal void BufferReturned(int bufferId, int bufferSize, int poolId) => this.WriteEvent(3, bufferId, bufferSize, poolId);
        ...
        internal void BufferTrimmed(int bufferId, int bufferSize, int poolId) => this.WriteEvent(4, bufferId, bufferSize, poolId);

        /// <summary>
        /// Event raised when we check to trim buffers.
        /// </summary>
        [Event(5, Level = EventLevel.Informational)]
        internal void BufferTrimPoll(int milliseconds, int pressure) => this.WriteEvent(5, milliseconds, pressure);
        ...
        internal unsafe void BufferDropped(int bufferId, int bufferSize, int poolId, int bucketId, BufferDroppedReason reason)
        {
            ...
            payload[4].DataPointer = (IntPtr)(&reason);
            this.WriteEventCore(6, 5, payload);
        }
    }
}
