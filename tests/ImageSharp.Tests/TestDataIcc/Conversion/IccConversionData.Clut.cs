...
namespace SixLabors.ImageSharp.Tests.Colorspaces.Icc
{
    public class IccConversionDataClut
    {
        ...
        internal static IccClut Clut3x1 = new IccClut(new float[][]
        {
            new float[] { 0.10f },
            new float[] { 0.20f },
            new float[] { 0.30f },
        ...
        internal static IccClut Clut2x1 = new IccClut(new float[][]
        {
            new float[] { 0.1f },
            new float[] { 0.2f },
            new float[] { 0.3f },
        ...
        internal static IccClut Clut1x2 = new IccClut(new float[][]
        {
            new float[] { 0f, 0.5f },
            new float[] { 0.25f, 0.75f, },
            new float[] { 0.5f, 1f },
        }, new byte[] { 3 }, IccClutDataType.Float);

        internal static IccClut Clut1x1 = new IccClut(new float[][]
        {
            new float[] { 0f },
            new float[] { 0.5f },
            new float[] { 1f },
