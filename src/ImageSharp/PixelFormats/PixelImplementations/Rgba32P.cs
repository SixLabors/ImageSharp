...
public partial struct Rgba32P : IPixel<Rgba32P>, IPackedVector<uint>
{
    ...
    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Rgba32P FromScaledVector4(Vector4 source) => FromAssociatedScaledVector4(source);

    /// <inheritdoc />
    public static Rgba32P FromVector4(Vector4 source) => FromAssociatedVector4(source);

    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Rgba32P FromUnassociatedVector4(Vector4 source) => FromUnassociatedScaledVector4(source);

    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Rgba32P FromAssociatedVector4(Vector4 source) => FromAssociatedScaledVector4(source);

    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Rgba32P FromUnassociatedScaledVector4(Vector4 source)
        => Vector4Converters.AssociatedRgbaCompatible.FromUnassociatedVector4ToRgba32P(source);

    /// <inheritdoc />
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Rgba32P FromAssociatedScaledVector4(Vector4 source)
    {
        ...
        return Vector4Converters.AssociatedRgbaCompatible.FromAssociatedVector4ToRgba32P(source);
    }
