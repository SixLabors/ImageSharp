...
internal static partial class Av1Inverse2dTransformer
{
    ...
    internal readonly struct Dct32Low8Operator : IAv1Transform1dOperator
    {
        ...
        public static void Transform(ReadOnlySpan<int> input, Span<int> output, Span<int> step, int cosBit, InlineArray12<byte> stageRange)
        {
            ...
            output[16] = Av1Transform1dMath.Clamp(step[16], stageRange[3]);
            output[17] = Av1Transform1dMath.Clamp(step[16], stageRange[3]);
            output[18] = Av1Transform1dMath.Clamp(step[19], stageRange[3]);
            output[19] = Av1Transform1dMath.Clamp(step[19], stageRange[3]);
            output[20] = Av1Transform1dMath.Clamp(step[20], stageRange[3]);
            output[21] = Av1Transform1dMath.Clamp(step[20], stageRange[3]);
            output[22] = Av1Transform1dMath.Clamp(step[23], stageRange[3]);
            output[23] = Av1Transform1dMath.Clamp(step[23], stageRange[3]);
            output[24] = Av1Transform1dMath.Clamp(step[24], stageRange[3]);
            output[25] = Av1Transform1dMath.Clamp(step[24], stageRange[3]);
            output[26] = Av1Transform1dMath.Clamp(step[27], stageRange[3]);
            output[27] = Av1Transform1dMath.Clamp(step[27], stageRange[3]);
            output[28] = Av1Transform1dMath.Clamp(step[28], stageRange[3]);
            output[29] = Av1Transform1dMath.Clamp(step[28], stageRange[3]);
            ...
            step[8] = Av1Transform1dMath.Clamp(output[8], stageRange[4]);
            step[9] = Av1Transform1dMath.Clamp(output[8], stageRange[4]);
            step[10] = Av1Transform1dMath.Clamp(output[11], stageRange[4]);
            step[11] = Av1Transform1dMath.Clamp(output[11], stageRange[4]);
            step[12] = Av1Transform1dMath.Clamp(output[12], stageRange[4]);
            step[13] = Av1Transform1dMath.Clamp(output[12], stageRange[4]);
            step[14] = Av1Transform1dMath.Clamp(output[15], stageRange[4]);
            step[15] = Av1Transform1dMath.Clamp(output[15], stageRange[4]);
            step[16] = output[16];
            ...
            output[5] = Av1Transform1dMath.Clamp(step[4], stageRange[5]);
            output[6] = Av1Transform1dMath.Clamp(step[7], stageRange[5]);
            output[7] = Av1Transform1dMath.Clamp(step[7], stageRange[5]);
            output[8] = step[8];
            ...
            step[0] = Av1Transform1dMath.Clamp(output[0], stageRange[6]);
            step[1] = Av1Transform1dMath.Clamp(output[1], stageRange[6]);
            step[2] = Av1Transform1dMath.Clamp(output[1], stageRange[6]);
            step[3] = Av1Transform1dMath.Clamp(output[0], stageRange[6]);
            step[4] = output[4];
            ...
            InlineArray12<byte> stageRange)
        {
            ...
            output.V16 = Av1Transform1dMath.Clamp(step.V16, stageRange[3]);
            output.V17 = Av1Transform1dMath.Clamp(step.V16, stageRange[3]);
            output.V18 = Av1Transform1dMath.Clamp(step.V19, stageRange[3]);
            output.V19 = Av1Transform1dMath.Clamp(step.V19, stageRange[3]);
            output.V20 = Av1Transform1dMath.Clamp(step.V20, stageRange[3]);
            output.V21 = Av1Transform1dMath.Clamp(step.V20, stageRange[3]);
            output.V22 = Av1Transform1dMath.Clamp(step.V23, stageRange[3]);
            output.V23 = Av1Transform1dMath.Clamp(step.V23, stageRange[3]);
            output.V24 = Av1Transform1dMath.Clamp(step.V24, stageRange[3]);
            output.V25 = Av1Transform1dMath.Clamp(step.V24, stageRange[3]);
            output.V26 = Av1Transform1dMath.Clamp(step.V27, stageRange[3]);
            output.V27 = Av1Transform1dMath.Clamp(step.V27, stageRange[3]);
            output.V28 = Av1Transform1dMath.Clamp(step.V28, stageRange[3]);
            output.V29 = Av1Transform1dMath.Clamp(step.V28, stageRange[3]);
            ...
            step.V8 = Av1Transform1dMath.Clamp(output.V8, stageRange[4]);
            step.V9 = Av1Transform1dMath.Clamp(output.V8, stageRange[4]);
            step.V10 = Av1Transform1dMath.Clamp(output.V11, stageRange[4]);
            step.V11 = Av1Transform1dMath.Clamp(output.V11, stageRange[4]);
            step.V12 = Av1Transform1dMath.Clamp(output.V12, stageRange[4]);
            step.V13 = Av1Transform1dMath.Clamp(output.V12, stageRange[4]);
            step.V14 = Av1Transform1dMath.Clamp(output.V15, stageRange[4]);
            step.V15 = Av1Transform1dMath.Clamp(output.V15, stageRange[4]);
            step.V16 = output.V16;
            ...
            output.V5 = Av1Transform1dMath.Clamp(step.V4, stageRange[5]);
            output.V6 = Av1Transform1dMath.Clamp(step.V7, stageRange[5]);
            output.V7 = Av1Transform1dMath.Clamp(step.V7, stageRange[5]);
            output.V8 = step.V8;
            ...
            // Stage 6 completes the low-frequency four-point DCT and rotates the next odd-frequency pairs.
            step.V0 = Av1Transform1dMath.Clamp(output.V0, stageRange[6]);
            step.V1 = Av1Transform1dMath.Clamp(output.V1, stageRange[6]);
            step.V2 = Av1Transform1dMath.Clamp(output.V1, stageRange[6]);
            step.V3 = Av1Transform1dMath.Clamp(output.V0, stageRange[6]);
            step.V4 = output.V4;
