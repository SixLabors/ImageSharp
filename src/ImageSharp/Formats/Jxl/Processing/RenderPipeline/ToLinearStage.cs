...
internal class ToLinearStage<TOperator> : RenderPipelineStageBase
    where TOperator : ToLinearStageOperators.IOperator
{
    private readonly ToLinearStageOperators.IOperator op;

    public ToLinearStage(Configuration configuration, JxlOutputEncodingInfo outputEncodingInfo)
        : base(configuration)
    {
    ...
    public override string Name => "ToLinear";
